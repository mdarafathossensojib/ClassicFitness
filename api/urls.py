...
from services.views import GymServiceViewSet, GymGalleryViewSet, FeedbackViewSet
...
classes_router.register('feedback', FeedbackViewSet, basename='class-feedback')
