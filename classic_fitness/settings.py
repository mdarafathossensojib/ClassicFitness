...
ROOT_URLCONF = 'classic_fitness.urls'
...
DJOSER = {
    ...
    'SERIALIZERS' : {
        ...
        'current_user': 'accounts.serializers.UserViewSerializer',
        'user': 'accounts.serializers.UserViewSerializer',
    },
}
